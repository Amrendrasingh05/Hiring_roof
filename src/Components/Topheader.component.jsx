  ...
  return (
    ...
    <nav className="navbar navbar-expand-lg navbar-dark bg-dark TopHeader">
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div className='text-light' style={{marginLeft:"15%"}}><a className="nav-link" href="/Profile">Profile</a></div>
        <div className='text-light'style={{marginLeft:"5%"}}><a className="nav-link" href="/">Logout</a></div>
      </div>
    </nav>
